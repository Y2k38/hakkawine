...
CREATE UNIQUE INDEX uk_node_labels_category_key on node_labels(category, key);

INSERT INTO node_labels (category, key, name) VALUES
...
('country', 'fr', 'France'),
('country', 'tr', 'Turkey'),
('route', 'cn2_gia', 'Telecom CN2 GIA'),
('route', 'cn2_gt', 'Telecom CN2 GT'),
('route', 'as9929', 'Unicom CU Premium (9929)'),
('route', 'as4837', 'Unicom 4837'),
('route', 'cmi', 'Mobile CMI'),
('route', 'bgp_optimized', 'BGP Optimized'),
('route', 'direct', 'Direct / Standard BGP'),
('route', 'iplc_iepl', 'IPLC / IEPL Private Line'),
('route', 'international', 'International BGP'),
('route', 'relay', 'Relay / Ingress Node'),
('tier', 'lite', 'Lite'),
('tier', 'standard', 'Standard'),
('tier', 'premium', 'Premium'),
('tier', 'one_time', 'One Time'),
('protocol', 'vless', 'VLESS'),
('protocol', 'hy2', 'Hysteria 2'),
('protocol', 'anytls', 'anyTLS'),
('protocol', 'shadowsocks', 'Shadowsocks'),
('pool', 'public', 'Public Resource Pool'),
('pool', 'backup', 'Backup Resource Pool'),
('role', 'direct', 'Direct Node'),
('role', 'ingress', 'Ingress Relay Node'),
('role', 'egress', 'Egress Landing Node');

CREATE TYPE template_type AS ENUM('client', 'server');

CREATE TABLE templates (
    id bigint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    name varchar(64) NOT NULL,
    type template_type NOT NULL,
    file_ext varchar(16) NOT NULL DEFAULT 'yaml',
    -- Client: {"ua_patterns": ["Clash", "Mihomo"]}
    -- Server: {"target_app": "mihomo"}
